...
Front-end developer working with Angular and TypeScript, and a Document Controller in construction who builds Python desktop tools to automate document control workflows. I bridge the gap between technical development and business needs.
...
- 💻 Front-end development with **Angular**, **TypeScript**, **RxJS**, **JavaScript (ES6+)**, **HTML5** and **CSS3**.
...
- **[Rental Showcase](https://github.com/anas-desoki-dev/rental-showcase)** ([Live demo](https://anas-desoki-dev.github.io/rental-showcase/)): Angular 17 app for browsing rental experiences, with RxJS category filtering, details routing, a Reactive Forms booking form, per-page SEO tags, unit tests, and English/Arabic support with RTL layout.
